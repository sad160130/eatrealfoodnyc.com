    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="manhattan" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700"><Link href="/restaurants/coletta-italian-vegan-restaurant" className="font-semibold text-jade hover:text-forest">Coletta Italian Vegan Restaurant in Kips Bay</Link> is the most cross-tagged addition in the directory this month — fully plant-based Italian that also carries gluten-free, dairy-free, and kosher certification, rated 4.7 across more than a thousand reviews.</p>
        </section>
        ...
        <section id="brooklyn" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700">One standout Brooklyn addition worth tracking: <Link href="/restaurants/atm-vegan-deli" className="font-semibold text-jade hover:text-forest">A.T.M. Vegan Deli in Clinton Hill</Link>, a triple-tag hidden gem (vegan + vegetarian + dairy-free) with a 4.5+ rating and under 200 reviews — a fully plant-based deli right at the sweet spot for newcomers worth seeking out.</p>
        </section>
