    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="brooklyn" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700">Two recent additions worth tracking: <Link href="/restaurants/savo" className="font-semibold text-jade hover:text-forest">SAVO in Sunset Park</Link> (Brooklyn), a fully plant-based kitchen with a 4.5+ rating and under 200 reviews, and <Link href="/restaurants/power-plant-kitchen" className="font-semibold text-jade hover:text-forest">Power Plant Kitchen in Battery Park City</Link> (Manhattan), a vegan + dairy-free spot serving the FiDi lunch crowd — both hit the hidden-gem sweet spot for newcomers worth seeking out.</p>
        </section>
