    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="manhattan" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700"><Link href="/restaurants/himalaya-vegan-organic-restaurant" className="font-semibold text-jade hover:text-forest">Himalaya Vegan &amp; Organic in Yorkville</Link> is a recent Manhattan addition worth knowing — Nepalese plant-based cooking in a corner of the Upper East Side with surprisingly few dedicated vegan options.</p>
        </section>
        ...
        <section id="brooklyn" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700">Three recent additions worth tracking: <Link href="/restaurants/avo-midtown-mn" className="font-semibold text-jade hover:text-forest">Avo in Midtown</Link> (Manhattan), a vegan + dairy-free spot with a 4.5+ rating and under 200 reviews, <Link href="/restaurants/falafel-plant" className="font-semibold text-jade hover:text-forest">Falafel Plant in Lincoln Square</Link> (Manhattan), a vegan + halal falafel concept, and <Link href="/restaurants/avas-lifeline" className="font-semibold text-jade hover:text-forest">Ava&apos;s Lifeline in Bed-Stuy</Link> (Brooklyn), a vegan + dairy-free hidden-gem kitchen — all three hit the sweet spot for newcomers worth seeking out.</p>
        </section>
