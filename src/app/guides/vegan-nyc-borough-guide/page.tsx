    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="brooklyn" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700">Two recent Brooklyn additions worth tracking: <Link href="/restaurants/electric-beets" className="font-semibold text-jade hover:text-forest">Electric Beets in Park Slope</Link>, a fully plant-based spot serving veg-forward bowls, and <Link href="/restaurants/yough" className="font-semibold text-jade hover:text-forest">Yough in Bushwick</Link>, a hidden-gem vegan kitchen with a 4.5+ rating and under 200 reviews — the exact sweet spot for newcomers worth seeking out.</p>
        </section>
