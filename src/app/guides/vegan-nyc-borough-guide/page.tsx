    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="brooklyn" className="mb-16 scroll-mt-24">
          ...
          <p className="text-lg leading-relaxed text-gray-700">One standout Manhattan addition worth tracking: <Link href="/restaurants/kraves-vegan-foods" className="font-semibold text-jade hover:text-forest">Kraves Vegan Foods in Lincoln Square</Link>, a triple-tag hidden gem (vegan + vegetarian + dairy-free) with a 4.5+ rating and under 200 reviews — right at the sweet spot for newcomers worth seeking out.</p>
        </section>
