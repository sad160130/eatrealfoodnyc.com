    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/the-chick-shop" className="font-semibold text-jade hover:text-forest">The Chick Shop in Midtown East</Link> (Manhattan halal + vegetarian), <Link href="/restaurants/pure-bowl-go" className="font-semibold text-jade hover:text-forest">Pure Bowl &amp; Go in Bushwick</Link> (Brooklyn whole-foods), <Link href="/restaurants/sobol-whitestone" className="font-semibold text-jade hover:text-forest">SoBol Whitestone in Whitestone</Link> (Queens whole-foods), <Link href="/restaurants/oishii-sushi" className="font-semibold text-jade hover:text-forest">Oishii Sushi in Great Kills</Link> (Staten Island), and <Link href="/restaurants/scratch-bar-grill-lounge" className="font-semibold text-jade hover:text-forest">Scratch Bar Grill &amp; Lounge in Wakefield</Link> (Bronx) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
