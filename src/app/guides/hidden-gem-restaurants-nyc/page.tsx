    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/avo-midtown-mn" className="font-semibold text-jade hover:text-forest">Avo in Midtown</Link> (Manhattan vegan + dairy-free), <Link href="/restaurants/curry-in-handi" className="font-semibold text-jade hover:text-forest">Curry In Handi in Bed-Stuy</Link> (Brooklyn halal-vegetarian), <Link href="/restaurants/ema-restaurant-bar" className="font-semibold text-jade hover:text-forest">EMA Restaurant Bar in Woodside</Link> (Queens halal), <Link href="/restaurants/asa-bowl" className="font-semibold text-jade hover:text-forest">ASA Bowl in New Brighton</Link> (Staten Island whole-foods), and <Link href="/restaurants/bites-on-valentine" className="font-semibold text-jade hover:text-forest">Bites on Valentine in Norwood</Link> (Bronx) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
