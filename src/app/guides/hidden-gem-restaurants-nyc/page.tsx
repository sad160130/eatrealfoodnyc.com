    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/brasa-peruvian-kitchen-financial" className="font-semibold text-jade hover:text-forest">Brasa Peruvian Kitchen in the Financial District</Link> (Manhattan whole-foods + low-calorie, Grade A), <Link href="/restaurants/baya-bar-acai-smoothie-shop-coney" className="font-semibold text-jade hover:text-forest">Baya Bar Acai &amp; Smoothie Shop in Coney Island</Link> (Brooklyn whole-foods), <Link href="/restaurants/daily-dose-juice-bar" className="font-semibold text-jade hover:text-forest">Daily Dose Juice Bar in St. Albans</Link> (Queens whole-foods + low-calorie), <Link href="/restaurants/basil-indian-cuisine" className="font-semibold text-jade hover:text-forest">Basil Indian Cuisine in Great Kills</Link> (Staten Island vegetarian), and <Link href="/restaurants/dea-burek" className="font-semibold text-jade hover:text-forest">Dea Burek in Belmont</Link> (Bronx halal) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
