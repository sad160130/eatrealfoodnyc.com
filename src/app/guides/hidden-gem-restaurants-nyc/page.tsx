    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/kraves-vegan-foods" className="font-semibold text-jade hover:text-forest">Kraves Vegan Foods in Lincoln Square</Link> (Manhattan vegan + dairy-free), <Link href="/restaurants/greenpot" className="font-semibold text-jade hover:text-forest">GreenPot in Greenpoint</Link> (Brooklyn whole-foods), <Link href="/restaurants/nabhya-indian-restaurant" className="font-semibold text-jade hover:text-forest">Nabhya Indian Restaurant in Kew Gardens</Link> (Queens vegetarian), <Link href="/restaurants/fuel-grill-juice-bar" className="font-semibold text-jade hover:text-forest">Fuel Grill &amp; Juice Bar in Tottenville</Link> (Staten Island whole-foods), and <Link href="/restaurants/mughal-curry-spot" className="font-semibold text-jade hover:text-forest">Mughal Curry Spot in Wakefield</Link> (Bronx vegetarian) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
