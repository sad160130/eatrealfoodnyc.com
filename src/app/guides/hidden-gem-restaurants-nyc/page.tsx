    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/mi-cafe" className="font-semibold text-jade hover:text-forest">MI Cafe in Hudson Yards</Link> (Manhattan whole-foods), <Link href="/restaurants/lifestyle-cafe" className="font-semibold text-jade hover:text-forest">Lifestyle Cafe in Bayside</Link> (Queens whole-foods), <Link href="/restaurants/tina-juice-bar" className="font-semibold text-jade hover:text-forest">Tina Juice Bar in Kingsbridge</Link> (Bronx whole-foods), <Link href="/restaurants/savo" className="font-semibold text-jade hover:text-forest">SAVO in Sunset Park</Link> (Brooklyn vegan), and <Link href="/restaurants/oda-caf" className="font-semibold text-jade hover:text-forest">Oda Caf&eacute; in New Brighton</Link> (Staten Island whole-foods) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
