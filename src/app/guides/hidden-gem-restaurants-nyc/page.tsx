    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="where-to-find-them" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate the cross-borough spread: <Link href="/restaurants/alfalfa-battery" className="font-semibold text-jade hover:text-forest">Alfalfa in Battery Park City</Link> (Manhattan whole-foods + vegetarian), <Link href="/restaurants/atm-vegan-deli" className="font-semibold text-jade hover:text-forest">A.T.M. Vegan Deli in Clinton Hill</Link> (Brooklyn vegan + dairy-free), <Link href="/restaurants/3-towns-cafe-juice-bar-gelato" className="font-semibold text-jade hover:text-forest">3 Towns Cafe Juice Bar &amp; Gelato in Whitestone</Link> (Queens whole-foods), <Link href="/restaurants/viva-juice-and-salad-bar" className="font-semibold text-jade hover:text-forest">Viva Juice and Salad Bar in Stapleton</Link> (Staten Island whole-foods), and <Link href="/restaurants/tulcingo-cafe-deli" className="font-semibold text-jade hover:text-forest">Tulcingo Cafe &amp; Deli in Wakefield</Link> (Bronx) all qualified as hidden gems on their first index — each rated 4.5+ with fewer than 200 reviews.
          </p>
        </section>
