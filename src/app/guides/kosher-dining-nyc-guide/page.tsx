    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions again cluster in Brooklyn&apos;s Borough Park kosher scene: <Link href="/restaurants/catch-co-by-tuv-taam-fish" className="font-semibold text-jade hover:text-forest">Catch &amp; Co (by Tuv Taam Fish) in Borough Park</Link> is a kosher fish counter that qualified as a hidden gem on its first index, and <Link href="/restaurants/dips" className="font-semibold text-jade hover:text-forest">Dips in Borough Park</Link> adds a high-volume kosher option nearby. In Manhattan, <Link href="/restaurants/coletta-italian-vegan-restaurant" className="font-semibold text-jade hover:text-forest">Coletta Italian Vegan Restaurant in Kips Bay</Link> is a rare kosher-and-fully-vegan overlap.
          </p>
        </section>
