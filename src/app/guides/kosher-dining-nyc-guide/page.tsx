    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions illustrate how kosher dining keeps spreading: <Link href="/restaurants/rafaelis-palace" className="font-semibold text-jade hover:text-forest">Rafaelis Palace in Forest Hills</Link> and <Link href="/restaurants/muscat-glatt" className="font-semibold text-jade hover:text-forest">Muscat Glatt in Far Rockaway</Link> both extend Queens&apos;s growing kosher scene (the latter is a rare halal-and-kosher overlap), while <Link href="/restaurants/sabra-shack" className="font-semibold text-jade hover:text-forest">Sabra Shack in Flatlands</Link> fills a quieter pocket of Brooklyn&apos;s Sephardic kosher landscape.
          </p>
        </section>
