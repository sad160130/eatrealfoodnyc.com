    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Two Manhattan additions are worth flagging for anyone managing celiac or gluten sensitivity: <Link href="/restaurants/coletta-italian-vegan-restaurant" className="font-semibold text-jade hover:text-forest">Coletta Italian Vegan Restaurant in Kips Bay</Link> is gluten-free, dairy-free, and kosher alongside its all-vegan menu, and <Link href="/restaurants/bardough" className="font-semibold text-jade hover:text-forest">BarDough in Hell&apos;s Kitchen</Link> holds a Grade A inspection while maintaining dedicated gluten-free preparation.
          </p>
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
