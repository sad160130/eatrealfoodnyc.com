    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions shift the weight toward Brooklyn: <Link href="/restaurants/cafe-mado" className="font-semibold text-jade hover:text-forest">Cafe Mado in Crown Heights</Link> (Grade A, halal and vegetarian), <Link href="/restaurants/bedawi-cafe" className="font-semibold text-jade hover:text-forest">Bedawi Cafe in Park Slope</Link> (Grade A), and <Link href="/restaurants/black-iris" className="font-semibold text-jade hover:text-forest">Black Iris in Fort Greene</Link> all expand the borough&apos;s coverage, while <Link href="/restaurants/dea-burek" className="font-semibold text-jade hover:text-forest">Dea Burek in Belmont</Link> is a Bronx halal hidden gem and <Link href="/restaurants/casa-galicia" className="font-semibold text-jade hover:text-forest">Casa Galicia in Astoria</Link> holds a Grade A in Queens.
          </p>
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Use our{" "}
