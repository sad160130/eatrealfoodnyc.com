    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions span the boroughs: <Link href="/restaurants/curry-in-handi" className="font-semibold text-jade hover:text-forest">Curry In Handi in Bed-Stuy</Link> brings South Asian halal-and-vegetarian cooking to Brooklyn&apos;s growing scene, <Link href="/restaurants/ema-restaurant-bar" className="font-semibold text-jade hover:text-forest">EMA Restaurant Bar in Woodside</Link> adds to Queens&apos;s halal coverage, and <Link href="/restaurants/falafel-crunch" className="font-semibold text-jade hover:text-forest">Falafel Crunch in Washington Heights</Link> is a rare halal-and-kosher overlap in Upper Manhattan.
          </p>
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Use our{" "}
