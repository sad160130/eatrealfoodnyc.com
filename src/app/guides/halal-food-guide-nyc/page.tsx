    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="best-neighborhoods" className="mb-16 scroll-mt-24">
          ...
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Recent additions weight to Queens&apos;s halal scene: <Link href="/restaurants/flame-kabab-and-grill" className="font-semibold text-jade hover:text-forest">Flame Kabab and Grill in Kew Gardens</Link> and <Link href="/restaurants/layla-halal-food" className="font-semibold text-jade hover:text-forest">Layla Halal Food in St. Albans</Link> both add to the borough&apos;s fast-growing coverage, while <Link href="/restaurants/moshes-falafel" className="font-semibold text-jade hover:text-forest">Moshe&apos;s falafel on the Upper West Side</Link> is a rare triple overlap — halal, kosher, and vegetarian all at once — in Manhattan.
          </p>
          <p className="mb-4 text-lg leading-relaxed text-gray-700">
            Use our{" "}
