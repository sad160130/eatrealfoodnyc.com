    ...
    <GuideLayout guide={guide}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section id="by-neighborhood" className="mb-16 scroll-mt-24">
          ...
          <p className="mt-6 text-lg leading-relaxed text-gray-700">
            Four recent additions worth a morning detour: <Link href="/restaurants/alfalfa-battery" className="font-semibold text-jade hover:text-forest">Alfalfa in Battery Park City</Link> and <Link href="/restaurants/tropical-juice-bar" className="font-semibold text-jade hover:text-forest">Tropical Juice Bar in Hamilton Heights</Link> anchor Manhattan&apos;s whole-foods-plus-low-calorie breakfast lineup, <Link href="/restaurants/3-towns-cafe-juice-bar-gelato" className="font-semibold text-jade hover:text-forest">3 Towns Cafe Juice Bar &amp; Gelato</Link> brings the same formula to Whitestone (Queens), and <Link href="/restaurants/viva-juice-and-salad-bar" className="font-semibold text-jade hover:text-forest">Viva Juice and Salad Bar</Link> extends it to Staten Island with a Stapleton juice-and-salad concept.
          </p>
        </section>
